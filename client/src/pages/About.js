      ...
      >
        ...
        <div className="devInfo flex-row flex-no-wrap justify-spacebetween m-2">
          <div className="flex-column justify-center mx-2">
            <h3>Andrew Moody</h3>
            <p>
              MERN & Music. I am attending Northwestern University's Full Stack
              Bootcamp, and graduated from Millikin University in 2019 with a
              degree in audio engineering. I'm an avid football fan & I love 72º
              days with a light breeze.
            </p>
          </div>
